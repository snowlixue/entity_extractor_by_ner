...
class Predictor:
    ...
    def predict_one(self, sentence):
        ...
        label_predicts, _ = tf.contrib.crf.crf_decode(logits, transition_params, inputs_length)
    ...
    def predict_test(self):
        ...
        for test_batch in tqdm(test_dataset.batch(self.dataManager.batch_size)):
            ...
            batch_pred_sequence_val, _ = tf.contrib.crf.crf_decode(logits_test, transition_params_test, inputs_length_test)
